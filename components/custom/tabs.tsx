...
export const CustomTabs = forwardRef<HTMLDivElement, TabsProps>(
...
export const CustomTabsList = forwardRef<HTMLDivElement, TabsListProps>(({ className, children, ...props }, ref) => {
  return (
    <div
      ref={ref}
...
export const CustomTabsTrigger = forwardRef<HTMLButtonElement, TabsTriggerProps>(
...
export const CustomTabsContent = forwardRef<HTMLDivElement, TabsContentProps>(
  ({ className, value, children, ...props }, ref) => {
    const context = useContext(TabsContext)
